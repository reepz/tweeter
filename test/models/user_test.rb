...
class UserTest < ActiveSupport::TestCase
  ...
  test "associated microposts should be destroyed" do
    @user.save
    @user.microposts.create!(content: "Chlopaki nie placza! Wiadomo, Olaf kiedys dobre robil. # nostalgia")
  ...
  test "feed should the rights posts" do
    michael = users(:michael)
    archer  = users(:archer)
    lana    = users(:lana)
